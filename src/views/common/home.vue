<template>
  <div class="mod-home">
    ...
    <ul>
      <li>开发中</li>
      <li>前端源码：<a href="https://github.com/lizxing/muzili-vue.git" target="_blank">https://github.com/lizxing/muzili-vue.git</a></li>
      <li>后端源码：<a href="https://github.com/lizxing/muzili.git" target="_blank">https://github.com/lizxing/muzili.git</a></li>
